...
const eeveesVideos: Video[] = [
  ...
  {
    url: 'https://www.youtube.com/watch?v=cxCH5LyQLTU',
    tags: [
      InfluencerId.eevees,
      VideoCategory.review,
      WheelId.ksS22
  ...
  {
    url: 'https://www.youtube.com/watch?v=_xRIaewNirM',
    tags: [
      InfluencerId.eevees,
      VideoCategory.review,
      WheelId.ksS22
  ...
  {
    url: 'https://www.youtube.com/watch?v=SVrTpzBbIWc',
    tags: [
      InfluencerId.eevees,
      VideoCategory.review,
      WheelId.ksS22
  ...
  {
    url: 'https://www.youtube.com/watch?v=djhenDsRzVI',
    tags: [
      InfluencerId.eevees,
      VideoCategory.review,
      VideoCategory.chatting,
  ...
  {
    url: 'https://www.youtube.com/watch?v=_Iz45h7t3T0',
    tags: [
      InfluencerId.eevees,
      VideoCategory.review,
