...
const InstagramPost = ({ maxWidth = 540, minWidth = 326, postUrl }: Props): JSX.Element => {
  const campaignLink = `${ postUrl }/?utm_source=ig_embed&amp;utm_campaign=loading`;
  ...
  return (
    <>
      <blockquote
        ...
        data-instgrm-permalink={ campaignLink }
        data-instgrm-version="14"
        style={ { background:'#FFF', border:0, borderRadius: '3px', boxShadow:'0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth, minWidth, padding:0, width: 'calc(100% - 2px)' } }>
        <div style={ { padding:'16px' } }>
          ...
          <p style={ { color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap' } }>
            <a
              ...
              rel="noreferrer"
            >
          Una publicación compartida de Rafa eucfinder.com (@rafa.pgarcia)
            </a>
          </p>
        </div>
      </blockquote>
